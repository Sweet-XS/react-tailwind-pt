            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                        <span className="bg-linear-to-b from-white to-gray-300 bg-clip-text text-transparent">Your best girl</span>
                        <br></br>
                        <span className="bg-linear-to-b from-blue-400 to-cyan-400 bg-clip-text text-transparent">Tzuyu Flow</span>
                    </h2>
                </div>
                            ...
                            <div className="flex-1 w-full">
                                <div className="relative group">
                                    ...
                                    group-hover:border-blue-600/50 transition-all duration-300">
                                        {/*ID interface*/}
                                        <div className="bg-gray-950 rounded-lg p-3 sm:p-4 text-xs sm:text-sm">
