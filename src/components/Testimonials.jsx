const testimonials = [
  {
    ...
    content:
      "Tzuyu has revolutionized how we write code. The intelligent suggestions save us hours every day.",
  },
  {
    ...
    content:
      "Tzuyu features are game-changers. We ship code faster and with more confidence than ever before.",
  },
  {
    name: "Emily Watson",
    role: "Super Fan",
    ...
    content:
      "I love having a Tzuyu concert every month.",
  },
];
        ...
        <section id="testimonials" className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="lg:w-1/2 w-full text-center lg:text-left">
                    ...
                    What Tzuyu fans are saying about us
                    </h2>
                    <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
                    Everything you need to be a Tzuyu fan.
                    </p>
                </div>
